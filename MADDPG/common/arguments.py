...
def get_args():
    ...
    # Environment
    # parser.add_argument("--scenario-name", type=str, default="predator_prey", help="name of the scenario script")
    ...
    parser.add_argument("--evaluate-rate", type=int, default=100000, help="how often to evaluate model")
