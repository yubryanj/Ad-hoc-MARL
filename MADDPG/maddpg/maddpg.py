...
class MADDPG:
    ...
    def train(self, transitions, other_agents):
        ...
        # Converts transitions which is an np array into a tensor5
        ...
        # Squared error of the value from this experience subtract the past valuation 
        ...
        # update the network
        # Clear the gradients for back propagation
